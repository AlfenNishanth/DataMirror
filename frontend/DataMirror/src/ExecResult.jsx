...
import { fetchComparisonResults } from "./api";
...
export default function ExecResult() {
  ...
  const sampleData = {
    ...
    detailed_comparison: {
      ...
      mismatched_records: [
        {
          id: 1,
          different_fields: ["DESIGNATION", "SALARY"],
          source1_data: {
  ...
  //     } else {
  //       console.warn(
  //         "No result data found in location state, using sample data"
  //       );
    ...
    const loadData = async () => {
      try {
        if (location.state && location.state.filePath) {
          ...
          const resultData = await fetchComparisonResults(
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-sm p-4 mb-6">
          ...
          <div className="flex justify-between text-xs text-gray-600 mb-3">
            ...
            <span>
              Total Execution Time: {data.execution_time.total.toFixed(2)}s
            </span>
          </div>
